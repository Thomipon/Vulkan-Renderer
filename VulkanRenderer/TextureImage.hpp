...
{
public:
	TextureImage(const std::filesystem::path& path, vk::ImageViewType viewType, const Renderer& app);
...
private:
	...
	static Image createImageFromPath(const std::filesystem::path& path, vk::ImageViewType viewType, const Renderer& app);
